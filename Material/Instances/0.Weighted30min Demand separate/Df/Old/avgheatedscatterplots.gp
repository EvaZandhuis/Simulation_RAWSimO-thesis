...
set output "avgheatedscatterplots.pdf"
set lmargin 13
set rmargin 13
# Parameters
...
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:3 w points linestyle 1 palette t "Overall"
set title "DistanceTraveledPerBot"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:4 w points linestyle 1 palette t "Overall"
set title "DistanceTraveled"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:5 w points linestyle 1 palette t "Overall"
set title "TripCount"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:6 w points linestyle 1 palette t "Overall"
set title "OrderThroughputTimeAvg"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:7 w points linestyle 1 palette t "Overall"
set title "OrderTurnoverTimeAvg"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:8 w points linestyle 1 palette t "Overall"
set title "OrderPileOneAvg"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:9 w points linestyle 1 palette t "Overall"
set title "OrdersHandled"
set xlabel "W2"
set ylabel "W3"
plot \
"avgheatedscatterplots.dat" u 1:2:10 w points linestyle 1 palette t "Overall"
reset
exit
