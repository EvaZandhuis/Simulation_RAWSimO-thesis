...
namespace RAWSimO.Core.Control.Defaults.ItemStorage
{
    ...
    /// </summary>
    public class EmptiestStorageManager : ItemStorageManager
    {
        /// <summary>
        /// Creates a new instance of this manager.
        /// </summary>
        /// <param name="instance">The instance this manager belongs to.</param>
        public EmptiestStorageManager(Instance instance) : base(instance)
        {
            _config = instance.ControllerConfig.ItemStorageConfig as EmptiestItemStorageConfiguration;
        ...
        /// </summary>
        private EmptiestItemStorageConfiguration _config;
        /// <summary>
        /// The last pod.
        /// </summary>
